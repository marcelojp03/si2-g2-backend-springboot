...
-- Sprint 1 + Sprint 2 (incluye correcciones)
-- PostgreSQL · Schema: sia
-- =========================================================
-- Este archivo arma desde cero el esquema completo a la fecha del
-- Sprint 2. Equivalente a ejecutar en orden:
--   1) db-script.sql (Sprint 1)
--   2) sprint-aulas-migration.sql
--   3) sprint2-rbac-migration.sql
--   4) sprint2-asistencia-migration.sql
--   5) sprint2-calificaciones-migration.sql
--   6) sprint2-security-audit-migration.sql
--   7) sprint2-horarios-migration.sql
--   8) sprint2-fixes-migration.sql
-- =========================================================
...
-- =========================================================
-- 13. DATOS INICIALES — roles, permisos, institución demo
-- =========================================================
