...
('CONFIGURACION_READ', 'Configuraci├│n: lectura', 'CONFIGURACION', 'READ', 'Permite consultar configuraci├│n institucional'),
('CONFIGURACION_WRITE', 'Configuraci├│n: escritura', 'CONFIGURACION', 'WRITE', 'Permite modificar configuraci├│n institucional'),
('GESTION_READ', 'Gesti├│n acad├®mica: lectura', 'GESTION_ACADEMICA', 'READ', 'Permite consultar estructura acad├®mica'),
('GESTION_WRITE', 'Gesti├│n acad├®mica: escritura', 'GESTION_ACADEMICA', 'WRITE', 'Permite modificar estructura acad├®mica'),
...
('OPERACION_READ', 'Operaci├│n: lectura', 'OPERACION', 'READ', 'Permite consultar inscripciones y asignaciones'),
('OPERACION_WRITE', 'Operaci├│n: escritura', 'OPERACION', 'WRITE', 'Permite modificar inscripciones y asignaciones'),
...
('MI_AREA_READ', 'Mi ├írea: lectura', 'MI_AREA', 'READ', 'Permite acceder al ├írea operativa del docente')
